...
const btnGetAPrediction = document.querySelector(".btn");
...
btnGetAPrediction.addEventListener('click', () => {
    ...
    const randPredictionIndex = Math.floor(Math.random() * options.length)

    const prediction = options[randPredictionIndex];
